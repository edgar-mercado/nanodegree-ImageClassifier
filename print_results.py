...
def print_results(results_dic, results_stats_dic, model, 
    ...
    x = PrettyTable()
    x.field_names = ["% Not-a-Dog Correct", "% Dog Correct", 
                     "% Breeds Correct", "% Match Labels"]
    x.add_row([results_stats_dic["pct_correct_notdogs"], results_stats_dic["pct_correct_dogs"], 
               results_stats_dic["pct_correct_breed"], results_stats_dic["pct_label-matches"]])
    print(x)
        ...
        for key in results_dic:
            ...
            if (print_incorrect_dogs):
                if (results_dic[key][3]==1 and results_dic[key][4]==0):
                    print("{:20}: {}".format(key,"Pet Image Label is a Dog - Classified as NOT-A-DOG"))
            if (print_incorrect_breed):
                if (results_dic[key][3]==0 and results_dic[key][4]==1):
                    print("{:20}: {}".format(key,"Pet Image Label is NOT-a-Dog - Classified as a-DOG"))
